...
press_range = [1050,1000,950,900,850,800]
...
for pressure in press_range:
    ...
    print('Pressure is ' + str(pressure) + ' hPa')

    # Calculate wet bulb temperature grid
    pres = pressure*100 # set general surface pressure to 1000 hPa
    ...
    np.savetxt("/home/ivanov/jupyternb/Stickiness/stick_array_pres" + str(pressure)+'.txt', result.x, delimiter =", ")